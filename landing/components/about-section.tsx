...
const STATS = [
  ...
  { label: "REQUESTS_LIMITED", value: "12.8B" },
  { label: "P99_EVAL_LATENCY", value: "0.4ms" },
]
      ...
      <div className="flex flex-col lg:flex-row gap-0 border-2 border-foreground">
        ...
        >
          ...
          <Image
            ...
            alt="Isometric view of the Limiter.io rate limiting infrastructure — Redis edge nodes, Kafka pipeline and API gateway"
            fill
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                Rate limiting built for
                <br />
                <span className="text-[#ea580c]">brutal throughput</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Limiter.io sits at your API edge and decides — atomically — whether
                  each request passes. Rules are evaluated inside Redis via Lua scripts,
                  so there are no race conditions and no round-trips. Five algorithms:
                  token bucket, fixed &amp; sliding window, sliding log, and leaky bucket.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Every decision streams to a Kafka pipeline and lands in your live
                  dashboard over WebSockets. Drop in the Go SDK and your Gin server is
                  protected in three lines — and if the gateway ever blinks, the SDK
                  fails open so your traffic never stops.
                </p>
              </motion.div>
