    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              ...
              <Panel key={t.id}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {canWriteProject && (
                      <>
                        <BrutalButton onClick={() => handleToggle(t)} variant="outline">
                          {t.enabled ? <ToggleRight className="size-4" /> : <ToggleLeft className="size-4" />}
                        </BrutalButton>
                        <BrutalButton onClick={() => handleDelete(t.id)} variant="danger">
        ...
        <Modal open={showModal} onClose={() => setShowModal(false)} title="New Tenant">
          <div className="space-y-4">
            <Field label="Tenant ID" hint="Unique identifier for this tenant">
            ...
            <Field label="Customer ID" hint="Your internal customer reference">
            ...
            <Field label="Max Requests" hint="Maximum requests in the window">
            ...
            <Field label="Window (ms)" hint="Time window in milliseconds">
